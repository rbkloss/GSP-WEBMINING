...
//        while (itr.hasNext()) {
//            itr.next().print(pw, (int) this.totalFreq);
//        }
//        pw.println();
//    }
    public void print(PrintWriter pw) {
        ...
        for (int i = this.size() - 1; i >= 0; i--) {
            this.get(i).print(pw, (int) this.totalFreq);
        }
        pw.println();
    }
...
//        while (itr.hasNext()) {
//            itr.next().print((int) this.totalFreq);
//        }
//        System.out.println();
//
//    }
    public void print() {
        System.out.println("PatternList(size:" + this.size() + "): \n Distribution :" + this.distribution + " Totalfreq : " + this.totalFreq + "\n");
        for (int i = this.size() - 1; i >= 0; i--) {
            this.get(i).print((int) this.totalFreq);
        }
        System.out.println();
    }
    ...
    public void trimForFreq() {
        if (this.distribution <= 0) {
            ...
            while (it.hasNext()) {
                ...
                if (current.freq < this.distribution * 0.5) {
                    it.remove();
                }
                i++;
            }
     ...
     * this class distribution.
     */
    public void trimForConfidence() {
        if (this.get(0).confidence <= 0) {
            System.out.println("Please initialize this object confidence first.");
            return;
        }
        Iterator<Pattern> it = this.iterator();
        int i = 0;
